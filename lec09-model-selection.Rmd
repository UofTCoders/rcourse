...
size (i.e. total number of observations) and $k$ being the number of parameters
in the most saturated model (i.e. the model with the most parameters) (Symonds
and Moussalli 2011). AIC~c~ is calculated as follows:
