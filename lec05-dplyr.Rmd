---
title: "Tidy and export data, reproducing figures"
---
...
it. In contrast, our R code will generate the contents of the `data_output`
...
# We could also use this expressions as an alternative to the above
suverys_complete <- na.omit(surverys) # Omits observations with NA in *any* column
# Or this one
suverys_complete <- surveys %>%
