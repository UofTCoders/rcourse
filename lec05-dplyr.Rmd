...
These are four excersices in exploratory data analyses, where you will train to 
...
answer solve these challenges, you will need to understand what data underlies a
...
looking at individual species? Phrased another way: since each species display
constant weight and hindfoot_length measures over time, what could be the cause
to the notable decrease over time for the average weight of all species pooled
together?
...
and read it into a dataframe called `plant_biomass`. Confirm that you data
...
markdown?"
- You will also need to search online to find out how you change the y-scale to
be constant within a species, but not between species (as in the paper figure).
