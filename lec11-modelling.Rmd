...
predicted $y$ after removing the other variables. To remove a variable you set
it to zero, but a zero weight doesn't make sense. It doesn't exist! So, we can
...
complicated than that depending on if you want to look at. So depending on your
