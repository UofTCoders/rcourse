...
```
What about changing the font? Let's get rid of the theme for a moment, which changes many aspects of the aesthetics at once. Let's spend some time building our own theme...
...
Here is qplot, a way of making super quick scatterplots in R.
```{r}
