...
```{r Load and examine data, message=FALSE, warning=FALSE}
library(tidyverse)
...
dfBeachModels %>% filter(term == "NAP") %>% dplyr::select(estimate, p.value)
```
...
```{r Fitzpatrick 2018 data, message=FALSE, warning=FALSE}
# Load in and examine data
Fitz_data <- paste0("https://raw.githubusercontent.com/James-S-Santangelo",
                    "/rcourse/master/data/Fitzpatrick_2018.csv")
