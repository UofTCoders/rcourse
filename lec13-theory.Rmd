...
knownledge of the system and the clarity of mind to know exactly what those
...
the relative survival abilities (denoted $W$) of individuals with different
genotypes. The dynamics of these two sub-populations can be expressed as
...
Note that $N{a}$ is **not** interchangeable with $p$, the algebra just happened
to worked out this way.
...
parasite doesn't actually become _infectious_ right away. There is a 10-14 day
...
selection coefficient, and is commonly denoted $s$. The fitness of _A_ relative
