...
I am emphazing this because I think it is one of the core features of working with an open language like R, many smart people readily share their material and discoveries not only for free, but in a way that allows others to modify and built on the material themselves. It really is "standing on the shoulders of giants", and there is a common saying in the open source world:
