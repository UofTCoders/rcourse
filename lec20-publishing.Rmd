...
Many people in the biomedical field follow [these guidelines](http://www.icmje.org/recommendations/browse/roles-and-responsibilities/defining-the-role-of-authors-and-contributors.html) for authorship.

**Important Note**: Have discussions about authorship early! This is crucial to
avoiding potential conflicts around authorship. Talking about any issues
with all involved early on is much better than waiting until when everything is
done and it's about time to submit.
...
- An article in Science Magazine about [authoship conventions](https://www.sciencemag.org/careers/2010/04/conventions-scientific-authorship)
- A paper about [gender disparity in authorship](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0066212)

### How to Credit Data and Software Creators?

As researchers in all sorts of fields begin to further embrace scripting and
...
and software creators compared to typical avenues of academic authorship?
...
(Adapted from [Berkeley Library Publishing Life Cycle](http://www.lib.berkeley.edu/scholarly-communication/publishing/publishing-lifecycle))
...
You can read [this article](https://www.nature.com/news/beat-it-impact-factor-publishing-elite-turns-against-controversial-metric-1.20224)
...
a research article, review, or body of scientific work that has yet to be
...
getting scooped from a published data source has been [empirically demonstrated](https://journals.plos.org/plosbiology/article?id=10.1371/journal.pbio.1002432)
...
be more common in basic science that has potential clinical/translational implications.
...
*This lesson has been adapted from [Lecture 3 of the original RQM
