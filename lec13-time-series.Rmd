...
$$y = A\text{sin}(kx + b) + c$$
A positive $b$ shifts the curve to the left, so species with larger $b$ get their leaves earlier in the spring,
according to our model. 

Limitation: didn't take into account that some species will have a longer season overall.
