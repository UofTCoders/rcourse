...
> 
> - Datasets to use (10-20 min)
> - The scientific method (20 min)
...
digraph rmarkdown {
    ...
    {CollectData AnalyzeData Report HypothesisFalse} -> Hypothesis
}')
```
...
5. Run the planned analyses (and additional ones that may come up as you work with and analyze the data).
6. Visualize or present the results from the analyses.
...
- Create a two or one word "team name". We'll use this to create a shared folder for everyone to use.
...
- Choose a possible dataset (or more) your team would like to work from (can also be datasets not presented in class) *(record them)*
