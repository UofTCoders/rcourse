...
- **Main goal**: To start the process of identifying which dataset to use and what some possible research questions there are
- Learn about the scientific method and *(the basics of)* how to apply it to your project
- Learn basics of group dynamics in team setting, how to share responsibilities and duties
...
- An example of an analysis plan (10 min)
- Team dynamics and assigning roles and tasks (20 min)
