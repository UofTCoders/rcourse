...
group of students as part of the first version of this course, created by Dr. 
Christie Bahlai. 

### Data

A list of recommended datasets can be found [here](). You are welcome to choose a
...
project should not be a reproduction of published analysis. 
...
2. Report styled as a journal article, with these or similar sections: 
    * Introduction 
    * Methods
    * Results 
    * Discussion 
...
The project report and code should be submitted on GitHub - each group will have 
their own GitHub repository to which you can upload your report and code. 

The self-assessment should be submitted through Quercus.
