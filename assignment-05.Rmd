...
dataset. (5 marks total)
    ...
    varying random effect strucure. Describe in one sentence what the optimal
    random effect structure of the model is and why. (0.5 marks)
...
entomoligcal innoculation rate (EIR). EIR is a measure of the number of bites by
