...
```{r}
plant_data <- read.csv("data/Santangelo_JEB_2018.csv", header = TRUE)
str(plant_data)
head(plant_data)
```
...
```{r}
df <- read.csv("data/Assign05_Question3.csv")
str(df)
```
