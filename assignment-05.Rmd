---
title: 'Assignment 5: Model selection and multivariate statistics'
output:
    html_document:
        toc: false
---
...
2. During the multivariate statistics lecture, we made use of vector community and malaria survey data collected by Mbogo _et al._ (2003) to disentangle the effects of vector abundance, species richness, and composition, on malaria prevalence. In this exercise, we will complete the analysis of the strucutral equation model we began building in class. (1.5 marks total)

![Figure 1. Path diagram representing hypothesized relationships between characteristics of vector communities and malaria prevalence. Paths (i.e., arrows) represent the direction of the hypothesized causal relationship between variables, with the arrow pointing from the predictor to the response. Paths are labeled with letters to facilitate discussion.](image/SEMfig.png)
