...
```{r}
fullModel <- lmer(Flower.date ~ HCN + Herbivory + Pollination + HCN:Herbivory + HCN:Pollination + (1|Genotype) + (1|Block) + (1|Genotype:Herbivory), data = Santangelo_data)
```
...
```{r}
fullModel <- lmer(Flower.date ~ HCN + Herbivory + Pollination + HCN:Herbivory + HCN:Pollination + (1|Block) + (1|Genotype) + (1|Genotype:Herbivory), data = Santangelo_data,
                  REML = TRUE)

model_noRandInteraction <- lmer(Flower.date ~ HCN + Herbivory + Pollination + HCN:Herbivory + HCN:Pollination + (1|Genotype) + (1|Block), data = Santangelo_data,
                  REML = TRUE)

model_noBlock <- lmer(Flower.date ~ HCN + Herbivory + Pollination + HCN:Herbivory + HCN:Pollination + (1|Genotype) + (1|Genotype:Herbivory), data = Santangelo_data,
                  REML = TRUE)

model_noBlockOrInteraction <- lmer(Flower.date ~ HCN + Herbivory + Pollination + HCN:Herbivory + HCN:Pollination + (1|Genotype), data = Santangelo_data,
                  REML = TRUE)
