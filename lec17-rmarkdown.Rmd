...
<pre class="markdown"><code>&#96;&#96;&#96;{r, eval=TRUE, echo=FALSE}`r ''`
library(ggplot2)
...
<pre class="markdown"><code>&#96;&#96;&#96;{r, fig.width=7, fig.height=7, eval=TRUE, echo=FALSE}`r ''`
library(ggplot2)  
qplot(mpg, wt, data=mtcars)
&#96;&#96;&#96;
</code></pre>
...
Click [here](https://github.com/UofTCoders/rcourse/blob/master/lec17-exercise.Rmd) for an example of how this file could look.
