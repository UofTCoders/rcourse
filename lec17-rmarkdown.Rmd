...
Take 5-10 minutes to read over the following blog post section on [reproducibility in science](http://bioconnector.org/workshops/r-rmarkdown.html#who_cares_about_reproducible_research) and [what's in it for you](http://bioconnector.org/workshops/r-rmarkdown.html#what’s_in_it_for_you).
