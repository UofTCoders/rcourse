...
hold all the references you need for your document (e.g. [EndNote](https://www.reed.edu/cis/help/LaTeX/EndNote.html))
...
for recognized citation styles is available here: https://github.com/citation-style-language/styles
...
metadata in the YAML header from "html_document" to "pdf_document"
