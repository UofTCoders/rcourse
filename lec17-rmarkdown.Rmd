...
for years. This includes the following:
    ...
    - code is well tested
    - for a take on "Continuous Analysis", read this [article from ELife](https://elifesciences.org/labs/e623676c/reproducibility-automated) or
    [this article in Nature Biotechnology with everything on Github!](https://github.com/greenelab/continuous_analysis)
...
> enables cataloging of datasets on sites like Data.gov and allows other to ask
> questions and access your datasets using code. For example, open US govenment
...
> researchers who are mandated to actually include data.json files, Data.gov is
...
Excellence's](http://govex.jhu.edu/) ["Open Data Metadata Guide"](https://www.gitbook.com/book/centerforgov/open-data-metadata-guide/details)
to get a better idea.

Now let's browse through the sections for more specific best practices.

To review, metadata about how the data was collected, succinct descriptions of
the data as well as information about when it was last updated are very important
to let people know if this is the right dataset for them.
Once people decide to use your dataset, things like licensing and column
metadata become very important, these are sometimes called data dictionaries.
Here is an example: http://www.utexas.edu/cola/redcap/_files/data_dictionary_example.jpg
...
please visit the [official documentation](http://pandoc.org/MANUAL.html#pandocs-markdown).
...
renumber them if things get reordered. The numbers in the rendered document will
be reordered for you, by order of occurrence! From the [Pandoc documentation](http://pandoc.org/MANUAL.html#footnotes):
...
5. Now Knit the file to pdf and compare with your neighbour to see if you got
