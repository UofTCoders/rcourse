---
title: 'Assignment 8: Project and team setup, echo=FALSE (8 marks)'
output:
    html_document:
        toc: false
---
...
4.  Create a folder in your forked repo called `doc/` (**Hint:** See [this
link](https://github.com/KirstieJane/STEMMRoleModels/wiki/Creating-new-folders-in-GitHub-repository-via-the-browser)
on creating folders from the GitHub editor). Create a file in the `doc/`
