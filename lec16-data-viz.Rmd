...
Colour blindness is common in the population, and red-green colour blindness in particular affects 8% of men and 0.5% of women.

Here are some guidelines for making your visualizations more accessible to people affected by colour blindness:

Don't use jet heatmaps. Jet colourmaps are often the default heatmap used in many visualization packages (you've probably seen them before). 

![A Jet Heatmap](./image/heatmap.png)
...
![Colour Blind](./image/colourblind.png)

[PS - jet heatmaps aren't so great for other reasons, too!](https://jakevdp.github.io/blog/2014/10/16/how-bad-is-your-colormap/)
