...
x labels so that they don't overlap. This will be discussed in much more detail
...
> 3. Hard mode: If you were to look at the average hindfoot length over time for
...
```{r}
# 3.a
# Answer: Since theaverage hinfoot length and average weight has remained
