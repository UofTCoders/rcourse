...
1. Visualization (3 marks)
    ...
    creating this plot for the purpose of evaluating temp temperature, what
    ...
    c. Create a single box plot that to simultaneously visualise temperature,
...
Run the following code to load the CO2 dataset.
    ...
    model. How much CO2 would you predict plants to uptake if atmospheric
...
3. Linear mixed-effects models (4 marks).
    ...
    of data. Avoid overlapping points in the figure. Also include 1 standard
    error around the mean. As a reminder, I have included the formula to
    calculate the standard error of the mean below. (1.5 marks).
