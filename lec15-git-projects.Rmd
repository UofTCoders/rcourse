...
hosts Git repositories. GitHub facilitates collaboration by allowing for code review 
and other useful features. In the spirit of 'working open' and ensuring scientific 
...
the `initial-edit` branch as soon as the merge has been completed. Great work --
your edits are now on the main repo!
