---
title: "Syllabus: EEB430H1 Theoretical Ecology and Reproducible Quantitative Methods using R [24L, 12P]"
---
...
All course information is accessible [on its own website](https://uoftcoders.github.io/rcourse/) and will also be stored on [Blackboard](https://portal.utoronto.ca/). You will have access to the Syllabus, Lecture Schedule, and Lecture slides. If you have any problem accessing the material, let us know via email right away so we can fix the problem.
...
| 2    | Sep 14 | Basic R – functions, data frames, indexing          | Joel           |
| 3    | Sep 19 | Intro to dplyr data wrangling                       | Joel           |
| 3    | Sep 21 | More dplyr, ggplot intro                            | Joel           |
| 4    | Sep 26 | Qualitative review of population models             | Madeleine      |
| 4    | Sep 28 | Qualitative population models in 2 dimensions       | Madeleine      |
...
| 6   | Oct 12 | Linear regression population dynamics models?       | Luke           |
| 7   | Oct 17 | Introduce data sets, hypotheses, start projects     | Luke           |
| 7   | Oct 19 | Project and Git setup in RStudio, tidy data         | Luke           |
| 8   | Oct 24 | Data visualization in R                             | Lindsay        |
| 8   | Oct 26 | Project work, data visualizations                   | Lindsay        |
| 9   | Oct 31 | Reproducible workflow, metadata, R Markdown         | Lina           |
| 9   | Nov 02 | Project work, metadata                              | 1 TA/group     |
| -    | Nov 07 | Fall break                                          | -              |
| -    | Nov 09 | Fall break                                          | -              |
| 10   | Nov 14 | Scientific collaboration, Git and GitHub            | Elliot         |
...
| Modelling in R        | Individual          | Oct 09     | 8     |
| Fitting models to data    | Individual      | Oct 16     | 8     |
