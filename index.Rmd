...
All course information is accessible [on its own website](https://uoftcoders.github.io/rcourse/) and on [Quercus](https://portal.utoronto.ca/), including the syllabus, assessments, and lecture slides. If you have any problem accessing the material, let us know via email right away so we can fix the problem.
...
Assignments will be distributed and submitted in the R Markdown format via Quercus or GitHub. Assignments will be handed out on Thursdays and are due 11:59 pm on the Tuesday eight weekdays later. _There will be a penalty of 5% per day (including week-ends) for late submissions._
