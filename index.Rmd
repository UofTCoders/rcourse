...
All course information is accessible [on its own website](https://uoftcoders.github.io/rcourse/) and on [Blackboard](https://portal.utoronto.ca/), including the syllabus and lecture slides. If you have any problem accessing the material, let us know via email right away so we can fix the problem.
